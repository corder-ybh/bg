            ...
            <div class="search-content">
                <form action="<?=site_url('admin/blogc/lst')?>" method="GET">
                    <table class="search-tab">
                        <tr>
                            <th width="70">标题:</th>
                            <td><input class="common-text" placeholder="标题" name="title" value="<?=$this->input->get('title');?>" id="" type="text"></td>
                        </tr>
                        <tr>
                            <th width="70">是否显示:</th>
                            <td>
                                <?php $isShow = $this->input->get('is_show'); ?>
                                <input type="radio" name="is_show" value="0" checked="checked" />全部
                        ...
                        <tr>
                            <td colspan="2"><input class="btn btn-primary btn2" name="sub" value="查询" type="submit"></td>
                        </tr>
                    </table>
                </form>
            </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td><?=$v->addtime?></td>
                            <td>
                                <a class="link-update" href="<?=site_url('admin/blogc/save/?id=').$v->id ?>">修改</a>
